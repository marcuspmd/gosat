<template>
    <div class="mt-6">
        <h4 class="text-lg font-semibold text-gray-800 mb-4">
            Melhores Ofertas Encontradas ({{ result.ofertas.length }})
        </h4>

        <div class="space-y-4">
            <div
                v-for="(oferta, index) in result.ofertas"
                :key="index"
        ...
        <div v-if="result.total_ofertas_encontradas > 3" class="mt-4 p-3 bg-blue-100 rounded-lg text-sm text-blue-800">
            <strong>Info:</strong> Foram encontradas {{ result.total_ofertas_encontradas }} ofertas.
